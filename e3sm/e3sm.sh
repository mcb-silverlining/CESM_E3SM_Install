...
# Machine and project
## updated MACHINE for running on AWS
readonly MACHINE=aws-hpc6a
...
## updated BRANCH and CHECKOUT
readonly CHECKOUT="maint-2.0"
readonly BRANCH="maint-2.0"
readonly CHERRY=(  )
readonly DEBUG_COMPILE=false

# Run options
## updated from hybrid to initial
readonly MODEL_START_TYPE="initial"  # 'initial', 'continue', 'branch', 'hybrid'
readonly START_DATE="0001-01-01"

# Additional options for 'branch' and 'hybrid'
## not used when run with 'initial'
readonly GET_REFCASE=TRUE
readonly RUN_REFDIR="/scratch/geostrat/E3SMv2/v2.LR.historical_1001/init"
...
readonly CASE_ROOT="/scratch/${USER}/E3SMv2/${CASE_NAME}"
